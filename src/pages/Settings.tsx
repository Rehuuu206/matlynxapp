...
import { User, Building2, Phone, MapPin, Camera, ArrowLeft, Save } from 'lucide-react';
...
const Settings: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const changed = 
      ...
      formData.shopName !== (profile.shopName || '') ||
      formData.companyName !== (profile.companyName || '') ||
      formData.phone !== (profile.phone || '') ||
      formData.street !== (profile.address?.street || '') ||
      formData.area !== (profile.address?.area || '') ||
      formData.city !== (profile.address?.city || '') ||
      formData.state !== (profile.address?.state || '') ||
      formData.pincode !== (profile.address?.pincode || '') ||
        ...
        <div className="max-w-2xl">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Update your profile details. Changes will be reflected on your listings.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button type="submit" className="w-full" size="lg" disabled={!hasChanges}>
